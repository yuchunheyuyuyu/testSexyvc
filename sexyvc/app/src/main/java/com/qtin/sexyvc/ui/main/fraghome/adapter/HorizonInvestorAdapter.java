...
public class HorizonInvestorAdapter extends RecyclerView.Adapter<HorizonInvestorAdapter.ViewHolder> {
    ...
    public HorizonInvestorAdapter(Context context, ArrayList<InvestorEntity> data) {
