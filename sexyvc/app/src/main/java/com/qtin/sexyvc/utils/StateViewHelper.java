...
public abstract class StateViewHelper {
    ...
    public void setMode(int mode) {
        ...
        if (mModeParam == null) {
            mModeParam = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        }
    ...
    private void checkMode(int mode) {
        if (mode != MODE_LOADING && mode != MODE_ERROR && mode != MODE_EMPTY && mode != MODE_CONTENT) {
