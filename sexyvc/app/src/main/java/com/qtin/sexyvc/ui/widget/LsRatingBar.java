 ...
 */
public class LsRatingBar extends View {
  ...
  private @ColorInt
  int starBackgroundColor;//星的背景色
  private @ColorInt
  int pressedBorderColor;//按下时边界颜色
  private @ColorInt
  int pressedFillColor;//按下时填充颜色
  private @ColorInt
  int pressedBackgroundColor;//按下时背景颜色
  private @ColorInt
  int pressedStarBackgroundColor;//按下时星星的背景色
  private int numberOfStars;//星星的数量
  private float starsSeparation;//星星之前的间隔距离
  private float desiredStarSize;//控件的长度
  private float maxStarSize;//星星的最大size
  private float stepSize;//步长
  private float rating;//分数
  private boolean isIndicator;//是否只是展示
  private Gravity gravity;
  private float starBorderWidth;//边界宽度
  ...
  public LsRatingBar(Context context) {
    super(context);
    initView();
  }

  public LsRatingBar(Context context, AttributeSet attrs) {
    super(context, attrs);
    parseAttrs(attrs);
    initView();
  }

  public LsRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private static class SavedState extends BaseSavedState {
      public static final Creator<SavedState> CREATOR = new Creator<LsRatingBar.SavedState>() {
          @Override
          public LsRatingBar.SavedState createFromParcel(Parcel parcel) {
              return new LsRatingBar.SavedState(parcel);
          }

          @Override
          public LsRatingBar.SavedState[] newArray(int size) {
              return new LsRatingBar.SavedState[size];
          }
      };
  ...
  private void animateRating(AnimationBuilder builder) {
    ...
    ratingAnimator.addListener(new AnimatorListener() {
      ...
      public void onAnimationEnd(Animator animator) {
        if (ratingListener != null) {
          ratingListener.onRatingChanged(LsRatingBar.this, rating, false);
        }
      }
  ...
  public interface OnRatingBarChangeListener {
     ...
     */
    void onRatingChanged(LsRatingBar simpleRatingBar, float rating, boolean fromUser);
  ...
  public class AnimationBuilder {
    ...
    private AnimationBuilder(LsRatingBar ratingBar) {
