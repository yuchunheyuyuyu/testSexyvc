 ...
 */
@ActivityScope
public class BaseProjectModel extends BaseModel<ServiceManager,CacheManager> implements BaseProjectContract.Model {

    @Inject
    public BaseProjectModel(ServiceManager serviceManager, CacheManager cacheManager) {
