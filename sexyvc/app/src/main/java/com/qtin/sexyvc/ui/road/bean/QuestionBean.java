...
public class QuestionBean implements Parcelable,DataTypeInterface{
    private long question_id;
    private String title;
    private int add_option;
    private int multi_select;
    private ArrayList<OptionFirstBean> options;
    ...
    public ArrayList<OptionFirstBean> getOptions() {
        return options;
    }

    public void setOptions(ArrayList<OptionFirstBean> options) {
    ...
    protected QuestionBean(Parcel in) {
        ...
        this.options = in.createTypedArrayList(OptionFirstBean.CREATOR);
    }
    ...
    @Override
    public int getType() {
        return DataTypeInterface.TYPE_QUESTION;
    }
}
