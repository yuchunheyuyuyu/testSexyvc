package com.qtin.sexyvc.ui.widget.ratingbar;
...
public class RatingBar extends View {
    ...
    protected static final int DEFAULT_FILLED_DRAWABLE = R.drawable.star_l_full;
    protected static final int DEFAULT_EMPTY_DRAWABLE = R.drawable.star_l_blank;
    ...
    protected void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            mStarSize = a.getDimensionPixelSize(R.styleable.RatingBar_starSizeValue, getPixelValueForDP(20));
            mMaxCount = a.getInt(R.styleable.RatingBar_numStarsValue, 5); // you usually go 1-5 stars when rating
            ...
            mRating = a.getFloat(R.styleable.RatingBar_ratingValue, mMinSelectionAllowed);
            isIndicator = a.getBoolean(R.styleable.RatingBar_isIndicator, false);
            mStepSize = a.getFloat(R.styleable.RatingBar_stepSizeValue, 1);
            a.recycle();
        } else {
            setDefaultDrawables();
        }
