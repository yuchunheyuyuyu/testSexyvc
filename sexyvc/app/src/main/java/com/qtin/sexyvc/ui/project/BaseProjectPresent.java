 ...
 */
@ActivityScope
public class BaseProjectPresent extends BasePresenter<BaseProjectContract.Model,BaseProjectContract.View> {
    private RxErrorHandler mErrorHandler;
    private AppManager mAppManager;
    private Application mApplication;

    @Inject
    public BaseProjectPresent(BaseProjectContract.Model model, BaseProjectContract.View rootView, RxErrorHandler mErrorHandler,
