 ...
 */
@ActivityScope
public class FundDetailPresent extends BasePresenter<FundDetailContract.Model,FundDetailContract.View> {
    private RxErrorHandler mErrorHandler;
    private AppManager mAppManager;
    private Application mApplication;

    @Inject
    public FundDetailPresent(FundDetailContract.Model model, FundDetailContract.View rootView, RxErrorHandler mErrorHandler,
