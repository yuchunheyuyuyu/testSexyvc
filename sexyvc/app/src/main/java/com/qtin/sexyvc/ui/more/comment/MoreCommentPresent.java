...
public class MoreCommentPresent extends BasePresenter<MoreCommentContract.Model,MoreCommentContract.View> {
    ...
    public void queryFundComment(long fund_id,final long comment_id,int page_size,int auth_state){
        mModel.queryFundDetail(mModel.getToken(),fund_id,comment_id,page_size,auth_state)
    ...
    public void queryInvestorComment(long investor_id,final long comment_id,int page_size,int auth_state){
