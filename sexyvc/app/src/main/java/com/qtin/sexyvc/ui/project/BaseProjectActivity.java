...
import com.qtin.sexyvc.ui.project.di.BaseProjectModule;
import com.qtin.sexyvc.ui.project.di.DaggerBaseProjectComponent;
 ...
 */
public class BaseProjectActivity extends MyBaseActivity<BaseProjectPresent> implements BaseProjectContract.View {
    ...
    protected void setupActivityComponent(AppComponent appComponent) {
        DaggerBaseProjectComponent.builder().appComponent(appComponent).baseProjectModule(new BaseProjectModule(this)).build().inject(this);
    }
    ...
    private void showDomainDialog() {
        ...
        domainAdapter = new TagAdapter<FilterEntity>(domainData) {
            ...
            public View getView(FlowLayout parent, int position, FilterEntity o) {
                View view = LayoutInflater.from(BaseProjectActivity.this).inflate(R.layout.item_filter, holder.flowLayout, false);
                //AutoUtils.auto(tv);
    ...
    public void showStageDialog() {
        ...
        holder.tvComfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(stage_id==0){
                    UiUtils.showToastShort(BaseProjectActivity.this,"请选择轮次标签");
                    return;
                }
